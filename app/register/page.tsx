...
export default function RegisterPage() {
    ...
    return (
        <div className="flex min-h-screen w-full items-center justify-center bg-background p-4">
            ...
            <motion.div className="w-full max-w-md space-y-6 rounded-lg border bg-card p-6 sm:p-8" initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
                <div className="text-center">
                    <Link href="/"><Image src="/axiora-logo.png" alt="Axiora Labs Logo" width={120} height={40} className="mx-auto" /></Link>
                    <h1 className="text-3xl font-bold text-card-foreground mt-4">Create Your Account</h1>
                    <p className="text-balance text-muted-foreground">Join Axiora to explore the frontiers of STEM.</p>
                </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <Input id="fullName" placeholder="Your Full Name" {...register("fullName")} className="pl-10" />
                        </div>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <Input id="password" type="password" placeholder="Password (min. 8 characters)" {...register("password")} className="pl-10" />
                        </div>
                    ...
                    <Button type="submit" className="w-full font-semibold !mt-6" disabled={isSubmitting}>
                        {isSubmitting ? <LoaderCircle className="mr-2 h-4 w-4 animate-spin" /> : 'Create Account'} 
                        {!isSubmitting && <ArrowRight className="ml-2 h-4 w-4" />}
                    </Button>
                </form>

                <div className="relative my-6"><div className="absolute inset-0 flex items-center"><span className="w-full border-t" /></div><div className="relative flex justify-center text-xs uppercase"><span className="bg-card px-2 text-muted-foreground">Or sign up with</span></div></div>
